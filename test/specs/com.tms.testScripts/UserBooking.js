describe("User Booking",async()=>{
    it("userBookingTest",async()=>{
  ...
  /* Admin Logout*/
    ...
    var userBookingID=await browser.$('(//tbody/tr)[last()]/td[2]').getText()
    ...
    userlogoutButton.click()
     ...
     await browser.$("//span[text()='Manage Booking']").click()
     var bookingConfirmButton=await browser.$("(//tbody/tr)[last()]/td[9]/span/a[text()='Confirm']")
     await bookingConfirmButton.waitForDisplayed({timeout:2000})
     await bookingConfirmButton.scrollIntoView()
     await bookingConfirmButton.isClickable()
     await browser.pause(2000)
     await bookingConfirmButton.click()
    // var availableBookingId=await browser.$$('//tbody/tr/td[1]/span[@class="bt-content"]').map((msg)=>{return msg.getText()})
     await browser.acceptAlert()
     var adminComfirmedMSg=await browser.$('//div[@class="succWrap"]').getText()
     console.log(adminComfirmedMSg);
